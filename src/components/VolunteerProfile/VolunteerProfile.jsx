  ...
  return (
    ...
    <div className='bg-gray font-quicksand'>
      ...
      <div className="sm:grid  grid-cols-4 grid-rows-8 gap-y-3 ">
          ...
          <p className="text-sm font-SourceSansPro sm:col-start-2 sm:col-end-4 sm:row-start-4 sm:justify-self-start ">{info.email}</p>
          <p className="text-sm font-SourceSansPro sm:col-start-2 sm:col-end-4 sm:row-start-5 sm:justify-self-start pb-3">{info.phone}</p>
      </div>
