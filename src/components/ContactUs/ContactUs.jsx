     ...
     <div className='ContactUs flex items-center justify-between'>
      ...
      <div className="lg:flex ">
          ...
          <div className="col-md-6 col-sm-12">
            ...
            <h1 className="text-6xl mb-10 " style={{color:"#1D3557",fontWeight: 'bold'}}>Contact Us</h1>
          ...
          <div className="FormContactUs xl:w-3/5 lg:w-3/5 pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr">
              <form id="contact" className="bg-white dark:bg-gray-800 py-4 px-8 rounded-tr" onSubmit={handleSubmit}>
                  <div className="block xl:flex w-full flex-wrap justify-between mb-6">
                      <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                          <div className="flex flex-col">
                              <label className="text-sm font-semibold mb-2" style={{color:"#1D3557"}}>Full Name</label>
                              <input required id="Fullname" name="Fullname" type="text" onChange={handleChange}value={formData.Fullname} className="FormTextContactUs focus:border focus:border-indigo-700 h-10 rounded border" style={{backgroundColor:"#DDDDDD",borderWidth: 0,width:"580px"}} placeholder="Full Name"/>
                          </div>
                      </div>
                  ...
                  <div className="flex w-full flex-wrap">
                      <div className="w-2/4 max-w-xs">
                          ...
                          <label className="text-sm font-semibold mb-2" style={{color:"#1D3557"}}>Email</label>
                              <input required id="email" name="email" type="email"   onChange={handleChange}value={formData.email} className="FormTextContactUs focus:border focus:border-indigo-700 h-10 rounded border"style={{backgroundColor:"#DDDDDD",borderWidth: 0 ,width:"580px"}} placeholder="example@email.com"/>
                          </div>
                      </div>
                  </div>
                  <div className="w-full mt-6">
                      ...
                      <label className="text-sm font-semibold mb-2" style={{color:"#1D3557"}}>Message</label>
                          <textarea placeholder="Type Here" name="Message" className="FormTextContactUs border-gray-300 border mb-4 rounded" onChange={handleChange}value={formData.Message} rows="9" id="Message" style={{backgroundColor:"#DDDDDD",borderWidth: 0,width:"580px"}} />
                      </div>
                      <button type="submit" className="rounded text-white px-8 py-3 focus:border-4 w-64" style={{backgroundColor:"#1D3557",borderWidth: 0}}onClick={() => {
