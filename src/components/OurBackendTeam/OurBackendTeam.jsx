import dilaraImg from "../../assets/dilaraImg.jpg";
import muslimImg from "../../assets/muslimImg.png";
import hafizImg from "../../assets/hafizImg.jpg";
import berkImg from "../../assets/berkImg.jpg";
import sobhanImg from "../../assets/sobhanImg.jpg";
import yamanImg from "../../assets/yamanImg.jpg";
                    ...
                    <div className='mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-3'>
                        <div className='group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-200 hover:bg-blue-light'>
                            ...
                            <div className='-mx-2 mt-3 flex'>
                                <a
                                    href='https://www.linkedin.com/in/muslem-omar-a53a33153/'
                                ...
                                <a
                                    href='https://github.com/muslimomar'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Github'
                                >
                                    <svg
                                ...
                                <a
                                    href='mailto:mislimumer@gmail.com'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Email'
                                >
                                    <svg
                        ...
                        <div className='group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-200 hover:bg-blue-light'>
                            <img
                                className='h-40 w-40 rounded-full object-cover ring-4 ring-blue-light'
                                src={hafizImg}
                                alt='Abdul Hafiz Mhammadah Profile'
                            />
                            ...
                            <div className='-mx-2 mt-3 flex'>
                                <a
                                    href='https://www.linkedin.com/in/hafizmh'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Linkedin'
                                >
                                    <svg
                                ...
                                <a
                                    href='https://github.com/abdulhafiz96'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Github'
                                >
                                    <svg
                                ...
                                <a
                                    href='mailto:abdulhafizmhammadah@gmail.com'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Email'
                                >
                                    <svg
                        ...
                        <div className='group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-200 hover:bg-blue-light'>
                            ...
                            <div className='-mx-2 mt-3 flex'>
                                ...
                                <a
                                    href='mailto:berk.akipek.96@gmail.com'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Email'
                                >
                                    <svg
                        ...
                        <div className='group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-200 hover:bg-blue-light'>
                            ...
                            <div className='-mx-2 mt-3 flex'>
                                <a
                                    href='https://www.linkedin.com/in/firtina/'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Linkedin'
                                >
                                    <svg
                                ...
                                <a
                                    href='https://github.com/dilarafirtina'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Github'
                                >
                                    <svg
                                ...
                                <a
                                    href='mailto:dilara_firtina@hotmail.com'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Email'
                                >
                                    <svg
                        ...
                        <div className='group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-200 hover:bg-blue-light'>
                            ...
                            <div className='-mx-2 mt-3 flex'>
                                <a
                                    href='https://www.linkedin.com/in/sobhan-shams-359547240/'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Linkedin'
                                >
                                    <svg
                                ...
                                <a
                                    href='https://github.com/sobhan-shams'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Github'
                                >
                                    <svg
                        ...
                        <div className='group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-200 hover:bg-blue-light'>
                            ...
                            <div className='-mx-2 mt-3 flex'>
                                <a
                                    href='https://www.linkedin.com/in/yaman-rajab-aa871710a/'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Linkedin'
                                >
                                    <svg
                                ...
                                <a
                                    href='https://github.com/yamanrajab90'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Github'
                                >
                                    <svg
                                ...
                                <a
                                    href='mailto:yamanrajab@hotmail.com'
                                    className='text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 mx-2 group-hover:text-white'
                                    aria-label='Email'
                                >
                                    <svg
